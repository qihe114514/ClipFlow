...
internal fun indicatorValue(dampedValue: Float, tabsCount: Int): Float = dampedValue.coerceIn(
    0f,
...
fun LiquidBottomTabs(
    ...
    BoxWithConstraints(modifier, contentAlignment = Alignment.CenterStart) {
        ...
        CompositionLocalProvider(LocalLiquidBottomTabScale provides {
        ...
        Box(
            Modifier
                ...
                .drawBackdrop(
                    ...
                    innerShadow = {
                        InnerShadow(radius = 8.dp * dampedDragAnimation.pressProgress, alpha = dampedDragAnimation.pressProgress)
                    },
                    layerBlock = {
